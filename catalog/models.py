...
class Book(models.Model):
    ...
    # Foreign Key used because book can only have one author, but authors can have multiple catalog.
    ...
    isbn = models.CharField(
        ...
        help_text='13 Character <a href="https://www.isbn-international.org/content/what-isbn'
                  '">ISBN number</a>')
    # ManyToManyField used because genre can contain many catalog. Books can cover many genres.
